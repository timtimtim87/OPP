...
class LEAPSAnalyzer:
    def __init__(self, csv_data_path):
        """
        Initialize LEAPS analyzer for January LEAPS contracts (20250117 expiry only)
    ...
    def find_best_contract_for_asset(self, asset):
        """
        Find the best contract for an asset based on target OPP criteria (20250117 expiry only)
        """
    ...
    def select_all_contracts(self):
        """Select the best contract for each asset (20250117 expiry only)"""
        print("\n" + "="*80)
    ...
    def run_complete_analysis(self):
        """Run the complete LEAPS analysis for 20250117 expiry"""
...
if __name__ == "__main__":
    # Initialize and run complete analysis for 20250117 expiry only

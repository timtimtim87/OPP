...
class LEAPSAnalyzerIWLS:
    def __init__(self, csv_data_path, iwls_csv_path):
        """
        Initialize LEAPS analyzer with IWLS-based asset selection (20250117 expiry only)
        """
        self.csv_data_path = csv_data_path
        self.iwls_csv_path = iwls_csv_path
        self.target_opp = 10.0  # Target 5% OPP
        self.target_expiry = '20250117'  # Fixed expiry date - January 17, 2025
        self.target_dte_range = (360, 370)  # Look for contracts around 365 DTE
        
        # Modified: Using range 10-20 instead of top 10
        self.top_n_assets = 20  # Still get 10 assets but from different range
        self.range_start = 5   # Start from 10th ranked asset
        self.range_end = 25     # End at 20th ranked asset
        ...
        print(f"Target expiry: {self.target_expiry} (January 17, 2025)")  # Updated date
    ...
    def select_candidate_assets(self):
        """Select assets ranked 10-20 by rolling range at ~365 DTE"""
        ...
        # Modified: Take assets ranked 10-20 instead of top 10
    ...
    def select_all_contracts(self):
        ...
        print(f"Target Expiry: {self.target_expiry} (January 17, 2025)")
        print("="*80)
